...
function setTitle(status, vector, connectivity, local, localTot, glob, globTot) {
    //52
    //202
    //22
    textTop.setText("  " + package.name + " " + package.version + " - position: " + status + "@" + vector + " - connection: " + connectivity + " - alive nodes: " + local + "/" + localTot + " local, " + glob + "/" +globTot +" global");
    screen.render();
}
