...
var blessed = require('blessed')
 ...
 , screen = blessed.screen({smartCSR: true})
  , grid = new contrib.grid({rows: 1, cols: 3, screen: screen});
   ...
   var map = grid.set(0, 0, 1, 2, contrib.map, {label: 'Nodes Location'});
map.addMarker({"lon" : "16.0000", "lat" : "65.4000", color: "red", char: "X" });


   var log = grid.set(0, 2, 1, 1, contrib.log,contrib.log,
  { fg: "green"
  , selectedFg: "green"
  , label: 'Server Log'});
